...
impl DashboardTest {
    fn new() -> (Self, iced::Task<LocalMessage>) {
        ...
        let display_data = AppDisplayData {
            ...
            library_sort: Default::default(),
            library_search: String::new(),
            open_identity: Default::default(),
            ...
            unison: tuner_gui::app::UnisonState::default(),
            unison_mode: tuner_gui::widgets::unison_display::UnisonMode::Displayed,
