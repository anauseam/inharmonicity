...
| 9 | Coincidence bracket, ±10 ¢ margin, j ≤ 7, 0.5 ¢ step | (b) OURS, documented + derived (report 0008); labels verified |
...
bass-derived floor are ours, documented (report 0008 Decision 2 — unchanged).
...
their derivations (report 0008). `pair_width_sensitivity` re-derived
