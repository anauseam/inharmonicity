...
| 10 | `fit_rho_phi` quadratic prior penalty | (b) OURS, documented (reg_weight = 0 recovers pure Eq 31; weight by LOO-CV+1-SE per report 0008) |
...
selection is LOO-CV + 1-SE per report 0008 (caller-side; see audit 12).
...
Wave-2 item 2 complete. Queue: `reports/audits/README.md`. Next: item 3,
