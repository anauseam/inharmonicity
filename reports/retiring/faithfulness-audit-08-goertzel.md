...
**Series:** faithfulness audits (status table in `faithfulness-audit-01-twm.md`), item 8
...
(mask_peaks and the sparsity metric as validated bespoke heuristics, with the sparsity
